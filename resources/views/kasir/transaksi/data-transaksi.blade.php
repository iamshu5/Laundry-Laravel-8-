                        ...
                        <tbody>
                            ...
                            @foreach($transaksi as $index => $dataTransaksi)
                                <tr>
                                    ...
                                    <td>{{ $dataTransaksi->outlet->id_outlet }} -
                                        {{ $dataTransaksi->outlet->nama_outlet }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary btn-sm rounded mb-1" href="{{ url($datauser->posisi . '/transaksi/detail-transaksi/' . $dataTransaksi->id_transaksi) }}">
